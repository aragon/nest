Below is the most recent specification of the Nest DAO and the corresponding new governance process for Nest. These changes are proposed to the community as an AGP by the Aragon Association in ANV-3. The specification is subject to be changed by the Aragon Association and the Nest DAO members if judged necessary mostly for technical reasons.
